...
export default function theBoy() {
  ...
  return (
    <body>
      <Links/>
      <div className={styles.title}>About The Boy</div> 
      <div id ="bio" className={styles.weddingParty}>
          <div className={styles.centerWrapper}>
           ...
           <div className={styles.center} ><Img className={styles.centerPic} fluid = {data.hammer.childImageSharp.fluid} /></div>
            <br/><br/>John Paul continues to follow his passion for baseball, playing for The Grind baseball team in Milford where he pitched and played the outfield. He also made the Freshman baseball team at Notre Dame High School.
