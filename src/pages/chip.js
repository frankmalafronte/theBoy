...
export default function Chip() {
  ...
  return (
    <body>
      <Links/>
      <div className ={styles.heroBottom} style={{paddingTop: '0px', paddingBottom: '0px'}}>Chip's Story</div>
      <div id ="bio" className={styles.weddingParty}>
          <div className={styles.centerWrapper}>
           ...
           <br/><br/>
            <p>A lifelong resident of Orange, Chip was a well-rounded athlete, sports enthusiast and a standout at Amity High School in basketball and baseball. His true passion was baseball which began in Orange Little League and he pursued well into his 30s with the West Haven Twilight League, where he was a Gold Bat recipient in 2007. </p>
            <p><br/>In addition to his love of sports, Chip was an avid chronicler who took a particular interest in the history of the U.S. Presidents; he visited Mount Rushmore in 2016. Chip was a big fan of music, especially classic rock, and had a special affinity for Van Halen’s album 5150. 
